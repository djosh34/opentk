...
**Goal:** Prove that the cache strategy implemented in Tasks 1 and 2 actually works. Optimization must already be present in the initial CI and Docker workflow tasks; this task is for measurement, verification, and tightening failures.
